...
export declare class Xerus {
    ...
    handleStatic(path: string): Promise<XerusHandler>;
    use(pathPrefix: string, ...middleware: XerusMiddleware[]): void;
    getMiddlewareChain(path: string, ...routeSpecificMiddleware: XerusMiddleware[]): XerusMiddleware[];
    getFinalHandler(finalMiddlewareChain: XerusMiddleware[], handler: XerusHandler): XerusHandler;
    at(path: string, handler: XerusHandler, ...routeSpecificMiddleware: XerusMiddleware[]): void;
    get(path: string, handler: XerusHandler, ...routeSpecificMiddleware: XerusMiddleware[]): void;
    post(path: string, handler: XerusHandler, ...routeSpecificMiddleware: XerusMiddleware[]): void;
    put(path: string, handler: XerusHandler, ...routeSpecificMiddleware: XerusMiddleware[]): void;
    delete(path: string, handler: XerusHandler, ...routeSpecificMiddleware: XerusMiddleware[]): void;
